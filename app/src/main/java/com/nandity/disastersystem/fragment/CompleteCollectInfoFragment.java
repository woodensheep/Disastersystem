                    ...
                    public void onResponse(String response, int id) {
                        ...
                        try {
                            ...
                            if("200".equals(status)){
                                ...
                                tvCollectInfoPlace.setText(oj.getString("survey_site"));
                                ...
                                tvCollectInfoDead.setText(oj.getString("dead_no"));
                                tvCollectInfoMiss.setText(oj.getString("sz_no"));
                                tvCollectInfoHeavyInjured.setText(oj.getString("zs_no"));
                                tvCollectInfoSoftInjured.setText(oj.getString("qs_no"));
                                tvCollectInfoEconomicLoss.setText(oj.getString("zj_money"));
                                tvCollectInfoHouseCollapseNumber.setText(oj.getString("house_kt_no"));
                                tvCollectInfoHouseCollapseArea.setText(oj.getString("house_kt_mj"));
                                tvCollectInfoHouseDamageNumber.setText(oj.getString("house_ss_no"));
                                tvCollectInfoHouseDamageArea.setText(oj.getString("house_ss_mj"));
                                tvCollectInfoAnotherDamage.setText(oj.getString("other_ss"));
                                tvCollectInfoFamily.setText(oj.getString("qz_person_h"));
                                tvCollectInfoPeople.setText(oj.getString("qz_person_no"));
                                tvCollectInfoHomeFamily.setText(oj.getString("qz_family_zj"));
                                tvCollectInfoHomePeople.setText(oj.getString("qz_person_zj"));
                                tvCollectInfoThreatenHouseNumber.setText(oj.getString("qz_house_no"));
                                tvCollectInfoThreatenHouseArea.setText(oj.getString("qz_house_area"));
                                tvCollectInfoAnotherThreaten.setText(oj.getString("qz_other"));
                                tvCollectInfoLandslideLength.setText(oj.getString("hp_c"));
                                tvCollectInfoLandslideWidth.setText(oj.getString("hp_k"));
                                tvCollectInfoLandslideArea.setText(oj.getString("hp_a"));
                                tvCollectInfoLandslideVolume.setText(oj.getString("hp_v"));
                                tvCollectInfoDistortionLength.setText(oj.getString("bx_c"));
                                tvCollectInfoDistortionWidth.setText(oj.getString("bx_k"));
                                tvCollectInfoDistortionArea.setText(oj.getString("bx_a"));
                                tvCollectInfoDistortionVolume.setText(oj.getString("bx_v"));
                                tvCollectInfoSlideDistance.setText(oj.getString("bx_hd"));
                                tvCollectInfoCrackNumber.setText(oj.getString("dl_no"));
                                tvCollectInfoCrackMinLength.setText(oj.getString("dl_min_c"));
                                tvCollectInfoCrackMaxLength.setText(oj.getString("dl_max_c"));
                                tvCollectInfoCrackMinWidth.setText(oj.getString("dl_min_k"));
                                tvCollectInfoCrackMaxWidth.setText(oj.getString("dl_max_k"));
                                tvCollectInfoMaxDislocation.setText(oj.getString("dl_xc"));
                                tvCollectInfoRockLength.setText(oj.getString("wy_c"));
                                tvCollectInfoRockWidth.setText(oj.getString("wy_g"));
                                tvCollectInfoRockVolume.setText(oj.getString("wy_v"));
                                tvCollectInfoCollapseVolume.setText(oj.getString("wy_bt"));
                                tvCollectInfoResidualVolume.setText(oj.getString("wy_cl"));
                                tvCollectInfoAnotherThings.setText(oj.getString("wy_other"));
                                tvCollectInfoMeasure.setText(oj.getString("take_steps"));
                                tvCollectInfoMeasureRemark.setText(oj.getString("take_steps_remark"));
                                tvCollectInfoDisposition.setText(oj.getString("next_plan"));
                                tvCollectInfoDispositionRemark.setText(oj.getString("next_plan_remark"));
                                tvCollectInfoGoTime.setText(oj.getString("departure_time"));
